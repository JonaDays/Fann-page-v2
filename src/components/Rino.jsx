    ...
    <div>
        <section className="relative h-screen flex flex-col items-center justify-end text-white py-25 px-3">
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden">
                <video className="min-w-full min-h-full z-1 absolute object-cover" src="https://res.cloudinary.com/dwy4sowpy/video/upload/v1762186659/6994521_Generative_Female_Model_3840x2160_tsw4kb.mp4" type="video/mp4" autoPlay muted loop></video>
            </div>
            <div className="z-2 flex flex-col items-center text-center px-6 md:px-22 lg:px-32 xl:px-42 text-white">
                <h1 className="text-5xl font-semibold tracking-tight text-balance text-white sm:text-8xl">
                    ...
                    <p className="mt-8 text-lg font-semibold text-pretty text-gray-300 sm:text-3xl/8">Armonía facial en minutos, sin bisturí.</p>
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-8 w-full mt-24">
                    <div className="max-md:px-4 lg:w-[80%]">
                        <h1 className="text-4xl md:text-[70px] md:leading-[4.7rem] font-semibold max-w-3xl bg-gradient-to-r from-black to-slate-600 bg-clip-text text-transparent pb-5">
                            Rinomodelación: el arte de perfeccionar sin cambiar tu esencia.
                        </h1>
                        <p className="font-cinzel text-md/7 md:text-lg/10 max-w-lg mt-3 text-slate-500 text-justify">
                            Procedimiento no quirúrgico que utiliza rellenos dérmicos para corregir imperfecciones nasales
                            como gibas o desviaciones mejorando la forma y simetría de la nariz logrando resultados instantáneos.
                    ...
                    <div clasclassNames="relative">
                        <div className="absolute inset-0 z-[-1] rounded-lg bg-gradient-to-r from-[#661FFF] via-[#d5ff19] to-[#2D73FF] blur-2xl opacity-50"></div>
                        <img className="max-w-md w-full max-h-[560px] rounded-[40px] max-md:px-3 md:mr-10" src="https://res.cloudinary.com/dwy4sowpy/image/upload/v1762187235/1_2_kr035t.jpg" alt=""/>
                    </div>
                </div>

    ...
    <div>
        <section className="relative h-screen flex flex-col items-center justify-end text-white py-25 px-3">
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden">
                <video className="min-w-full min-h-full z-1 absolute object-cover" src="https://res.cloudinary.com/dwy4sowpy/video/upload/v1760647909/4264868-uhd_3840_2160_30fps_ijbv9c.mp4" type="video/mp4" autoPlay muted loop></video>
            </div>
            <div className="z-2 flex flex-col items-center text-center px-6 md:px-22 lg:px-32 xl:px-42 text-white">
                <h1 className="text-5xl font-semibold tracking-tight text-balance text-white sm:text-8xl">
                    RELLENO DE LABIOS <br /> 
                </h1>
                    <p className="mt-8 text-lg font-semibold text-pretty text-gray-300 sm:text-3xl/8">Labios Sensuales y Naturales</p>
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-8 w-full mt-24">
                    <div className="max-md:px-4 lg:w-[80%]">
                        ...
                        <p className="font-cinzel text-md/7 md:text-lg/10 max-w-lg mt-3 text-slate-500 text-justify">Suaviza arrugas dinámicas como las líneas de expresión en la frente, entrecejo y patas de gallo.
                            Con ácido hialurónico, se mejora el volumen, la forma y la hidratación de los labios, logrando
                            una apariencia natural, armoniosa y personalizada. Este tratamiento también permite corregir
                            asimetrías y realzar los rasgos sin perder la expresión propia. Ideal para quienes desean labios
                            más definidos, con mayor hidratación o un sutil efecto de volumen.
                        </p>
                    ...
                    <div className="relative">
                        ...
                        <video className="max-w-md w-full max-h-[560px] rounded-[40px] max-md:px-3 md:mr-10" src="https://res.cloudinary.com/dwy4sowpy/video/upload/v1760647892/RELLENO_DE_LABIOS_hohcfm.mp4" type="video/mp4" autoPlay muted loop></video>
                    </div>
                </div>

    ...
    <div>
        <section className="relative h-screen flex flex-col items-center justify-end text-white py-25 px-3">
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden">
                <video className="min-w-full min-h-full z-1 absolute object-cover" src="https://res.cloudinary.com/dwy4sowpy/video/upload/v1762396630/3763023-uhd_3840_2160_25fps_hq5wk7.mp4" type="video/mp4" autoPlay muted loop></video>
            </div>
            <div className="z-2 flex flex-col items-center text-center px-6 md:px-22 lg:px-32 xl:px-42 text-white">
                <h1 className="text-5xl font-semibold tracking-tight text-balance text-white sm:text-8xl">
                    Limpieza Facial - Diamond Glow <br /> 
                </h1>
                    <p className="mt-8 text-lg font-semibold text-pretty text-gray-300 sm:text-3xl/8">Brilla con luz propia: una piel tan radiante como un diamante.</p>
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-8 w-full mt-24">
                    <div className="max-md:px-4 lg:w-[80%]">
                        <h1 className="text-4xl md:text-[70px] md:leading-[4.7rem] font-semibold max-w-3xl bg-gradient-to-r from-black to-slate-600 bg-clip-text text-transparent pb-5">
                            Diamond: la perfección de una piel suave, limpia y resplandeciente.
                        </h1>
                        <p className="font-cinzel text-md/7 md:text-lg/10 max-w-lg mt-3 text-slate-500 text-justify">
                            Limpieza facial médica avanzada que exfolia, limpia y nutre la piel al mismo tiempo, gracias a
                            su punta de diamante y succión controlada.
                        </p>
                        <p className="font-cinzel text-md/7 md:text-lg/10 max-w-lg mt-3 text-slate-500 text-justify">
                            ¿Qué la hace diferente? <br></br>
                            • Remueve impurezas, células muertas y puntos negros <br></br>
                            • Hidrata profundamente con sueros personalizados <br></br>
                            • Aporta un glow inmediato <br></br>
                            • Recomendada para todo tipo de piel <br></br>
                            • Luce una piel fresca, saludable, radiante y brillante <br></br>
                        </p>
                        <p className="font-cinzel text-md mt-2 text-slate-600 font-bold pt-5">
                            - Duración de la sesión: 30min.
                        </p>
                        <p className="font-cinzel text-md mt-2 text-slate-600 font-bold pt-5">
                            - Recuperación: evitar fuentes de calor por 1 semana.
                        </p>
                        <p className="font-cinzel text-md mt-2 text-slate-600 font-bold pt-5">
                            - Sesiones: 3 o 4 
                        </p>
                    ...
                    <div clasclassNames="relative">
                        ...
                        <video className="max-w-md w-full max-h-[560px] rounded-[40px] max-md:px-3 md:mr-10" src="https://res.cloudinary.com/dwy4sowpy/video/upload/v1762396828/LIMPIEZA_FACIALmp4_2_c0zgsk.mp4" type="video/mp4" autoPlay muted loop></video>
                    </div>
                </div>

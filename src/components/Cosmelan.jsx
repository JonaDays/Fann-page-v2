    ...
    <div>
        <section className="relative h-screen flex flex-col items-center justify-end text-white py-25 px-3">
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden">
                <video className="min-w-full min-h-full z-1 absolute object-cover" src="https://res.cloudinary.com/dwy4sowpy/video/upload/v1762398557/4594916-uhd_4096_2160_25fps_bffabo.mp4" type="video/mp4" autoPlay muted loop></video>
            </div>
            <div className="z-2 flex flex-col items-center text-center px-6 md:px-22 lg:px-32 xl:px-42 text-white">
                <h1 className="text-5xl font-semibold tracking-tight text-balance text-white sm:text-8xl">
                    ...
                    <p className="mt-8 text-lg font-semibold text-pretty text-gray-300 sm:text-3xl/8">Tratamiento intensivo para manchas.</p>
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-8 w-full mt-24">
                    <div className="max-md:px-4 lg:w-[80%]">
                        <h1 className="text-4xl md:text-[70px] md:leading-[4.7rem] font-semibold max-w-3xl bg-gradient-to-r from-black to-slate-600 bg-clip-text text-transparent pb-5">
                            Una piel uniforme, luminosa y sin cicatrices: eso es Cosmelan.
                        </h1>
                        <p className="font-cinzel text-md/7 md:text-lg/10 max-w-lg mt-3 text-slate-500 text-justify">
                            Cosmelan es un tratamiento despigmentante de uso médico, reconocido a nivel mundial por su
                            eficacia en la eliminación de manchas de diferentes orígenes: melasma, hiperpigmentación
                            postinflamatoria, manchas solares o envejecimiento.
                        </p>
                        <p className="font-cinzel text-md/7 md:text-lg/10 max-w-lg mt-3 text-slate-500 text-justify">
                            Actúa directamente sobre el origen del problema, regulando la producción de melanina y
                            unificando el tono de la piel de forma progresiva y segura. <br></br>
                            Se realiza en dos fases:
                        </p>
                        <p className="font-cinzel text-md/7 md:text-lg/10 max-w-lg mt-3 text-slate-500 text-justify">
                            1. Aplicación en consultorio de la mascarilla despigmentante.<br></br>
                            2. Fase domiciliaria con productos específicos que prolongan y potencian el resultado.
                        </p>
                    ...
                    <div clasclassNames="relative">
                        ...
                        <video className="max-w-md w-full max-h-[560px] rounded-[40px] max-md:px-3 md:mr-10" src="https://res.cloudinary.com/dwy4sowpy/video/upload/v1762398608/ELIMINACION_MANCHAS_s0bh9l.mp4" type="video/mp4" autoPlay muted loop></video>
                    </div>
                </div>

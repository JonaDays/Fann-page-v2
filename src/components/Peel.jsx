    ...
    <div>
        <section className="relative h-screen flex flex-col items-center justify-end text-white py-25 px-3">
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden">
                <video className="min-w-full min-h-full z-1 absolute object-cover" src="https://res.cloudinary.com/dwy4sowpy/video/upload/v1762395851/3741666-hd_1920_1080_25fps_u7leiz.mp4" type="video/mp4" autoPlay muted loop></video>
            </div>
            <div className="z-2 flex flex-col items-center text-center px-6 md:px-22 lg:px-32 xl:px-42 text-white">
                <h1 className="text-5xl font-semibold tracking-tight text-balance text-white sm:text-8xl">
                    ...
                    <p className="mt-8 text-lg font-semibold text-pretty text-gray-300 sm:text-3xl/8">Un nuevo comienzo para tu piel.</p>
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-8 w-full mt-24">
                    <div className="max-md:px-4 lg:w-[80%]">
                        <h1 className="text-4xl md:text-[70px] md:leading-[4.7rem] font-semibold max-w-3xl bg-gradient-to-r from-black to-slate-600 bg-clip-text text-transparent pb-5">
                            Peeling químico profesional: ciencia que revela una piel nueva.
                        </h1>
                        <p className="font-cinzel text-md/7 md:text-lg/10 max-w-lg mt-3 text-slate-500 text-justify">
                            Aplicamos soluciones dermatológicas especiales para exfoliar las capas superficiales de la piel,
                            eliminando células muertas y acelerando la renovación celular.
                        </p>
                        <p className="font-cinzel text-md/7 md:text-lg/10 max-w-lg mt-3 text-slate-500 text-justify">
                            Protocolos: <br></br>
                            ...
                            • Acne <br></br>
                            • Rosacea <br></br>
                            • Poros dilatados <br></br>
                            • Antienvejecimiento <br></br>
                            • Hidratación <br></br>
                            • Revitalizares <br></br>
                            • Antioxidantes <br></br>
                            • Blanqueamiento genital <br></br>
                        </p>
                        <p className="font-cinzel text-md/7 md:text-lg/10 max-w-lg mt-3 text-slate-500 text-justify">
                           El protocolo se personaliza según tu tipo de piel y necesidades específicas. 
                        </p>
                    ...
                    <div clasclassNames="relative">
                        ...
                        <video className="max-w-md w-full max-h-[560px] rounded-[40px] max-md:px-3 md:mr-10" src="https://res.cloudinary.com/dwy4sowpy/video/upload/v1762395919/NATURAL_PEEL_govhcj.mp4" type="video/mp4" autoPlay muted loop></video>
                    </div>
                </div>

    ...
    <div>
        <section className="relative h-screen flex flex-col items-center justify-end text-white py-25 px-3">
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden">
                <video className="min-w-full min-h-full z-1 absolute object-cover" src="https://res.cloudinary.com/dwy4sowpy/video/upload/v1760386028/video_3_ltmd8e.mp4" type="video/mp4" autoPlay muted loop></video>
            </div>
            <div className="z-2 flex flex-col items-center text-center px-6 md:px-22 lg:px-32 xl:px-42 text-white">
                <h1 className="text-5xl font-semibold tracking-tight text-balance text-white sm:text-8xl">
                    ...
                    <p className="mt-8 text-lg font-semibold text-pretty text-gray-300 sm:text-3xl/8">No es magia, es ciencia: estimula tu colágeno y recupera tu juventud.</p>
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-8 w-full mt-24">
                    <div className="max-md:px-4 lg:w-[80%]">
                        <h1 className="text-4xl md:text-[70px] md:leading-[4.7rem] font-semibold max-w-3xl bg-gradient-to-r from-black to-slate-600 bg-clip-text text-transparent pb-5">
                            Sculptra: belleza que evoluciona contigo.
                        </h1>
                        <p className="font-cinzel text-md/7 md:text-lg/10 max-w-3xl mt-3 text-slate-500 text-justify">
                            Bioestimulación avanzada a base de ácido poli-L-láctico, que estimula de forma progresiva la
                            producción natural de colágeno en la piel logrando una regeneración profunda y gradual que
                            mejora visiblemente la firmeza, la textura y el volumen facial a lo largo del tiempo con
                            resultados que pueden durar más de 2 años.
 
                        </p>
                        <p className="font-cinzel text-md/7 md:text-lg/10 max-w-3xl mt-3 text-slate-500 text-justify">
                            Ideal para pacientes que buscan un rejuvenecimiento profundo con resultado natural y duradero.
                    ...
                    <div clasclassNames="relative">
                        ...
                        <video className="max-w-md w-full max-h-[560px] rounded-[40px] max-md:px-3 md:mr-10" src="https://res.cloudinary.com/dwy4sowpy/video/upload/v1762368017/sculptra_wyaq8c.mp4" type="video/mp4" autoPlay muted loop></video>
                    </div>
                </div>

    ...
    <div>
        <section className="relative h-screen flex flex-col items-center justify-end text-white py-25 px-3">
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden">
                <video className="min-w-full min-h-full z-1 absolute object-cover" src="https://res.cloudinary.com/dwy4sowpy/video/upload/v1760646535/13008912-uhd_3840_2160_25fps_o4sutd.mp4" type="video/mp4" autoPlay muted loop></video>
            </div>
            <div className="z-2 flex flex-col items-center text-center px-6 md:px-22 lg:px-32 xl:px-42 text-white">
                <h1 className="text-5xl font-semibold tracking-tight text-balance text-white sm:text-8xl">
                    REDUCCIÓN DE PAPADA: LIPOENZIMAS <br /> 
                </h1>
                    <p className="mt-8 text-lg font-semibold text-pretty text-gray-300 sm:text-3xl/8">Perfil facial perfecto</p>
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-8 w-full mt-24">
                    <div className="max-md:px-4 lg:w-[80%]">
                        <h1 className="text-4xl md:text-[70px] md:leading-[4.7rem] font-semibold max-w-3xl bg-gradient-to-r from-black to-slate-600 bg-clip-text text-transparent pb-5">
                            Redefine tu perfil: Lipopapada
                        </h1>
                        <p className="font-cinzel text-md/7 md:text-lg/10 max-w-lg mt-3 text-slate-500 text-justify">
                            Este procedimiento utiliza enzimas lipolíticas para disolver la grasa localizada en la zona
                            submentoniana, ayudando a definir el contorno mandibular, Ideal para quienes buscan eliminar el
                            doble mentón de forma segura y efectiva.
                        </p>
                    ...
                    <div class="relative">
                        ...
                        <img class="max-w-md w-full max-h-[560px] rounded-[40px] max-md:px-3 md:mr-10" src="https://res.cloudinary.com/dwy4sowpy/image/upload/v1760387886/pexels-thirdman-8053956_hnehce.jpg" alt=""/>
                    </div>
                </div>

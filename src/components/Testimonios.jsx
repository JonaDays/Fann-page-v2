...
import Vale from '../assets/val_testimonios.jpg'
import Sofie from '../assets/sofi_testimonios.jpg'
import Jona from '../assets/jona_testimonios.jpg'
import Clau from '../assets/Clau_testimonios.jpg'
...
const cardsData = [
        {
            ...
            handle: '@val_salazarg',
            comment: 'Me encanta visitar a la doctora Fanny, todos los tratamientos que me ha hecho han tenido un resultado espectacular 🩷 la súper recomiendo!',
            date: '16 de mayo de 2025'
        },
        {
            image: Sofie,
            name: 'Ingrid Sofia Domínguez',
            handle: '@Ingridsofia18',
            comment: 'Encantada con los tratamientos que me he hecho aquí, muy feliz con los resultados 🤩',
        ...
        },
        {
            ...
            name: 'Jonathan Days',
            handle: '@jona_days',
            comment: 'El trato de la doctora Fanny siempre ha sido el mejor y siempre está a la vanguardia',
            date: '5 de Junio de 2025'
        },
        {
            image: Clau,
            name: 'Claudia Raengell',
            handle: '@clau_raengell',
            comment: 'Mi piel siempre luce radiante y hermosa cada que visito a la doctora Fanny, 100% recomendada',
            date: '10 de mayo de 2025'
        },
    ];
    ...
    return (
        ...
        `}</style>
            ...
            <div className="marquee-row w-full mx-auto max-w-5xl overflow-hidden relative">
                <h1 className="text-3xl font-semibold text-center mx-auto pt-10">Lo que piensan nuestros clientes</h1>
